...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('HdcLyN6btY', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gB5h1xHyTS', 0, 'V93T+cbL3F3b-YE1Kngopr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KhwyJZ3lsr', 0, 'V93T+cbL3F3b-YE1Kngopr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mc9v3LjODf', 0, 'V93T+cbL3F3b-YE1Kngopr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lxyn67W66F', 0, 'V93T+cbL3F3b-YE1Kngopr', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Acme/AdminBundle/Resources/views'), '!AcmeHome');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ClusterBundle/Resources/views'), 'AcmeCluster');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ClusterBundle/Resources/views'), '!AcmeCluster');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/AccueilBundle/Resources/views'), 'AcmeAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/AccueilBundle/Resources/views'), '!AcmeAccueil');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ContactBundle/Resources/views'), 'AcmeContact');
        $instance->addPath(($this->targetDirs[3].'/src/Acme/ContactBundle/Resources/views'), '!AcmeContact');
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'AcmeClusterBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Acme/ClusterBundle'),
                    'namespace' => 'Acme\\ClusterBundle',
                ),
                'AcmeAccueilBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/Acme/AccueilBundle'),
                    'namespace' => 'Acme\\AccueilBundle',
                ),
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AcmeClusterBundle' => 'Acme\\ClusterBundle\\AcmeClusterBundle',
                'AcmeAccueilBundle' => 'Acme\\AccueilBundle\\AcmeAccueilBundle',
